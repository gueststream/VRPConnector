...
<div class="vrpgrid_6 userbox alpha " id="newuserbox">
    ...
    <div class="padit">
        ...
        <br><br><br>
        <a href="/vrp/book/step3/?obj[Arrival]=<?php echo esc_attr($data->Arrival); ?>&obj[Departure]=<?php echo esc_attr($data->Departure); ?>&obj[PropID]=<?php echo esc_attr($obj['PropID']); ?>" class="bookingbutton rounded">Continue with Reservation</a>
        </br>        </div>
