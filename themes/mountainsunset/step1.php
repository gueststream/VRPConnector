...
<div class="clear"></div>  <p style="text-align:right;"><a
        href="/vrp/book/step1/?obj[Arrival]=<?php echo esc_attr($data->Arrival); ?>&obj[Departure]=<?php echo esc_attr($data->Departure); ?>&obj[PropID]=<?php echo esc_attr($_GET[ 'obj' ][ 'PropID' ]); ?>&obj[Adults]=<?php echo esc_attr($_GET[ 'obj' ][ 'Adults' ]); ?>&obj[Children]=<?php echo esc_attr($_GET[ 'obj' ][ 'Children' ]); ?>&printme=1"
